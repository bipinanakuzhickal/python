...
# print(credit_number[:5]) # returns the characters till the end index (excluded) from the beginning if the start index is not mentioned
...
# print(credit_number[4::]) # reverses the string, add -1 at the end to reverse the given string
...
# print("Actual value of price1 is ",price1)
# print("Actual value of price2 is ",price2)
# print("Actual value of price3 is ",price3)
...
#     print(i+1)
#     time.sleep(2) # delays execution for a given number of seconds. The argument may be a floating-point number for subsecond precision.
